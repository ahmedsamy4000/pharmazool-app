...
class MedicalEquipments extends StatefulWidget {
  const MedicalEquipments({Key? key}) : super(key: key);

  @override
  _MedicalEquipmentsState createState() => _MedicalEquipmentsState();
}

class _MedicalEquipmentsState extends State<MedicalEquipments> {
  @override
    ...
    return BlocBuilder<AppCubit, AppStates>(builder: (context, state) {
      ...
      return Scaffold(
          appBar: AppBar(
            ...
            title: const Text("Medical Equipments"),
            centerTitle: true,
          ),
          body: Scaffold(
                      ...
                      Container(
                        ...
                        child: ClipOval(
                          child: SizedBox.fromSize(
                            ...
                            child: Image.asset('assets/images/medicaleq.jpg',
                                fit: BoxFit.cover),
                          ),
                        ),
                      )
                          ...
                          child: TextField(
                            ...
                            onSubmitted: (value) {
                              cubit.getMedicinesByID(
                                  id: 13, search: searchcontrolled.text);
                            },
                            style: TextStyle(
                              fontSize: 12,
                            ),
